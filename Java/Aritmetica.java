...
public class Aritmetica {
    public static void main(String[] args) {
        // mensaje principal del tema
        System.out.println("Aritmetica");
        // declaracion de objetos y variables
        Scanner input = new Scanner(System.in); // objeto (input) de la clase Scanner
        float n1, n2, suma, mult, div, resta, modulo = 0;// variables de operacion
